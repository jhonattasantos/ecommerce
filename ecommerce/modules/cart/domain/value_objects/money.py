...
class Money:
    ...
    def __lt__(self, other: Money) -> bool:
        ...
        if self.currency != other.currency:
            raise ValueError(f"Não é possível comparar moedas diferentes: {self.currency} e {other.currency}")
    ...
    def to_dict(self) -> dict:
        ...
        """
        return {
            'amount': float(self.amount),  # Converter para float para serialização
